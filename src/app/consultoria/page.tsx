  ...
  return (
    <>
      <header className="flex flex-col items-center justify-center px-4">
        <Header
          title="Consultoria"
          text="Elaborar a parte interna de um móvel requer, um bom planejamento, cuidado e atenção com as medidas. É necessário focar na distribuição adequada das gavetas, prateleiras e de toda parte interna, trazendo maior praticidade, aproveitamento dos espaços e ainda mais beleza para os seus móveis. A organização com a marcenaria inteligente é a solução sob medida para os clientes mais exigentes."
        />
        <HeroVideoDialog
