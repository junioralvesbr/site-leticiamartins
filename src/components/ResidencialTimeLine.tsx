...
export function ResidencialTimeLine() {
  const data = [
    {
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-xs font-normal text-neutral-600 md:text-sm dark:text-neutral-200">
            Um local de encontro para sua família e preparo de comidas incriveis, tudo organizado para proporciona momentos inesqueciveis ao redor da mesa.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <img
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-4 text-xs font-normal text-neutral-600 md:text-sm dark:text-neutral-200">
  ...
  return (
    <div className="relative w-full overflow-clip">
      <Timeline
        ...
        subTitle="Somos apaixonados por organização e atuamos em todos os ambientes da sua casa."
      />
    </div>
  );
}
